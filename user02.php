...
file_put_contents('data/data2.txt',$name2 . $question2 . $answer2 . $time , FILE_APPEND);
...
<body>
  ...
  <h1>ママの部屋</h1>
		...
		<!-- BGMを流す -->
		<section>
			<audio src="img/nc307979.mp3" id="audio" pause="pause" loop="loop"></audio>
			<div id="btn-gold">BGMを再生／停止</div>
		</section>

		<div class="linkbtn">
		<button class="top" onclick="window.open('./index.php')">TOPへ</button>
		<button class="kanon" onclick="window.open('./user01.php')">カノンの部屋へ</button>
		<button class="papa" onclick="window.open('./user03.php')">パパの部屋へ</button>
</div>

<form action="user02.php" action="user04.php" method="POST">
  ...
  <ul id="output">
	<?php 
$data = file_get_contents('./data/data2.txt');
echo nl2br($data);
